...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    if (!SDL_CreateWindowAndRenderer("Static Draw Function", WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_RESIZABLE, &window, &renderer)) {
...
{
    DrawFunction(renderer, WINDOW_WIDTH, WINDOW_HEIGHT);
